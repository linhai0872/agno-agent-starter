...
# 各厂商默认 API Key 环境变量名
PROVIDER_DEFAULT_ENV_VARS: Dict[ModelProvider, Optional[str]] = {
...
class ReasoningConfig:
    ...
    google_thinking_level: Optional[Literal["low", "high"]] = None
...
class WebSearchConfig:
    ...
    volcengine_sources: Optional[List[str]] = None
...
class MultimodalConfig:
    ...
    # 图片像素限制
    volcengine_max_pixels: Optional[int] = None
    volcengine_min_pixels: Optional[int] = None
...
class ModelConfig:
    ...
    ollama_host_env: Optional[str] = None
    ...
    litellm_api_base_env: Optional[str] = None
